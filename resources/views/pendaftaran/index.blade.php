                                ...
                                <tbody>
                                    @foreach($app as $key => $value)
                                        <tr>
                                            ...
                                            <td>
                                                <a class='btn btn-info btn-xs' href="{{ route('anggota-perkhidmatan.edit', $value->id) }}"><i class="fas fa-edit"></i>KEMASKIN</a> 
                                                <form action="{{ route('anggota-perkhidmatan.destroy', $value->id) }}" method="POST" style="display: inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-xs" onclick="return confirm('Anda pasti untuk hapus?')">
